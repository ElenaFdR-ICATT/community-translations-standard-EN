...
This is a repository for unofficial translations of the [Standard for Public Code](https://standard.publiccode.net), provided by the community. There is also a [Dutch translation hosted by CodeforNL](https://github.com/codefornl/community-translations-standard).
